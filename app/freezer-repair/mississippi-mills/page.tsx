      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          ...
          <p className="text-center text-gray-700 mb-8">
            Freezers are just the beginning — here are our other services in Mississippi Mills:
          </p>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
            ...
            <Link href="/fridge-repair/mississippi-mills" className="text-center p-4 bg-gray-50 rounded-lg hover:bg-primary-50 hover:text-primary-700 transition-colors">
            ...
            <Link href="/freezer-installation" className="text-center p-4 bg-gray-50 rounded-lg hover:bg-primary-50 hover:text-primary-700 transition-colors">
              Freezer Installation Mississippi Mills
            </Link>
          </div>
