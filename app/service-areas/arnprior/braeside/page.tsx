...
const reasons = [
  "Every repair backed with 90-day coverage.",
  "Insured, approachable experts.",
  "Arnprior techs close to your area.",
...
const faqs = [
  {
    ...
    answer: <span>Yes, our techs serve Braeside frequently.</span>,
  },
  {
    question: "Do you fix ovens and cooktops?",
    answer: <span>Yes, all major appliances are covered.</span>,
  },
  {
    question: "Do you provide installation?",
    answer: (
      <span>
        Absolutely. Learn more on our{" "}
        <Link
          href="/appliance-installation/ottawa"
          className="font-semibold text-accent-600 underline decoration-2 underline-offset-4 hover:text-accent-700"
        >
          appliance installation page
        </Link>
        .
      </span>
    ),
      ...
      <div className="container-custom py-16 text-gray-800 space-y-16">
        ...
        <section className="space-y-6">
          <h2 className="text-3xl font-semibold text-gray-900">
            Appliances We Repair in Braeside
          </h2>
          ...
          <p className="text-gray-700">
            ...
            keeps new appliances working right. See all our services through{" "}
            <Link
              href="/service-areas/arnprior"
              className="font-semibold text-accent-600 underline decoration-2 underline-offset-4 hover:text-accent-700"
            >
        ...
        <section className="space-y-6">
          <h2 className="text-3xl font-semibold text-gray-900">
            Explore Braeside While We Fix
          </h2>
          <p className="text-gray-700">
            While your appliance is being repaired, discover Braeside:
          </p>
          <ul className="space-y-3 text-sm text-gray-700">
        ...
        <section className="space-y-6">
          <h2 className="text-3xl font-semibold text-gray-900">
            FAQs for Braeside Appliance Repair
          </h2>
        ...
        <section className="rounded-2xl bg-gray-900 p-8 text-white">
          <h2 className="text-3xl font-semibold">
            Trusted local service in Braeside — contact 613-413-6969 or{" "}
            <a
