...
export default function DryerRepairKanataPage() {
  return (
    <>
      <ServiceHero
        title="Dryer Repair Services in Kanata You Can Trust"
        description="Clothes coming out damp even after a full cycle? Or maybe your dryer just won't turn on? Fixer Appliance Repair provides expert dryer service in Kanata, with quick diagnostics and dependable repairs. We handle Whirlpool, Samsung, LG, GE, Maytag, Frigidaire, and more."
