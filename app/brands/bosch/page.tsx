...
const boschAppliances = [
  {
    ...
    media: <div className="h-40 w-full rounded-lg bg-primary-100 flex items-center justify-center text-primary-700 font-semibold">
      <Image src="/brands/bosch/washer.webp" alt="Bosch Washer" width={100} height={100} />
    </div>,
  },
  {
    title: "Bosch Dryers",
    ...
    media: <div className="h-40 w-full rounded-lg bg-primary-100 flex items-center justify-center text-primary-700 font-semibold">
      <Image src="/brands/bosch/dryer.webp" alt="Bosch Dryer" width={100} height={100} />
    </div>,
  },
  {
  ...
  },
  {
    ...
    media: <div className="h-40 w-full rounded-lg bg-primary-100 flex items-center justify-center text-primary-700 font-semibold">
      <Image src="/brands/bosch/dishwasher.webp" alt="Bosch Dishwasher" width={100} height={100} />
    </div>,
  },
  {
    ...
    media: <div className="h-40 w-full rounded-lg bg-primary-100 flex items-center justify-center text-primary-700 font-semibold">
      <Image src="/brands/bosch/cooktop.webp" alt="Bosch Cooktop" width={100} height={100} />
    </div>,
  },
  {
    ...
    media: <div className="h-40 w-full rounded-lg bg-primary-100 flex items-center justify-center text-primary-700 font-semibold">
      <Image src="/brands/bosch/mw.webp" alt="Bosch Microwave" width={200} height={200} />
    </div>,
  },
];
