...
const services = [
  ...
  { label: "Electric Cooktop Repair Mississippi Mills", href: "/cooktop-repair/mississippi-mills" },
    ...
    <>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="max-w-5xl mx-auto">
            <h2 className="heading-md text-center mb-12">Common Microwave Issues We Fix in Mississippi Mills</h2>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <h2 className="heading-md mb-6 text-center">Discover Mississippi Mills While We Work on Your Microwave</h2>
            ...
            <p className="text-gray-700">
              ...
              >
                See what’s going on in Mississippi Mills
              </a>
            </p>
          </div>
        </div>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="heading-md mb-0">FAQ – Microwave Repair in Mississippi Mills</h2>
            </div>
      ...
      <section className="section-padding bg-gradient-to-r from-accent-500 to-accent-600 text-white">
        <div className="container-custom text-center">
          <h2 className="heading-md mb-4 text-white">Schedule Your Microwave Repair in Mississippi Mills</h2>
          <p className="text-lg mb-6 max-w-3xl mx-auto">
            Serving Almonte, Appleton, and surrounding areas — schedule your microwave repair now.
          </p>
