...
const services = [
  ...
  { label: "Electric Cooktop Repair Vanier", href: "/cooktop-repair/vanier" },
    ...
    <>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="max-w-5xl mx-auto">
            <h2 className="heading-md text-center mb-12">Common Microwave Issues We Fix in Vanier</h2>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <h2 className="heading-md mb-6 text-center">Discover Vanier While We Work on Your Microwave</h2>
            ...
            <p className="text-gray-700">
              ...
              >
                Check what’s happening in Vanier
              </a>
            </p>
          </div>
        </div>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="heading-md mb-0">FAQ – Microwave Repair in Vanier</h2>
            </div>
      ...
      <section className="section-padding bg-gradient-to-r from-accent-500 to-accent-600 text-white">
        <div className="container-custom text-center">
          <h2 className="heading-md mb-4 text-white">Schedule Your Microwave Repair in Vanier</h2>
          <p className="text-lg mb-6 max-w-3xl mx-auto">
            Need your microwave fixed fast? Reach out now to schedule service with Fixer Appliance Repair.
          </p>
