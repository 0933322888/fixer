      ...
      <section className="section-padding bg-gray-100">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <h2 className="heading-md mb-4">Explore Nepean While We Work on Your Microwave</h2>
            <p className="text-lg text-gray-700 mb-6">Turn repair time into discovery time:</p>
